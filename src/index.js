...
module.exports = {
  FlexmarkCore,
  AUTOLINK_TYPES: AUTOLINK_TYPES,
  INLINE_STACK_STATES: INLINE_STACK_STATES,
  INLINE_STACK_TYPES: INLINE_STACK_TYPES,
  LIST_TYPES: LIST_TYPES,
  NODE_TYPES: NODE_TYPES,
  PRECEDED_CHARACTER_TYPES: PRECEDED_CHARACTER_TYPES,
